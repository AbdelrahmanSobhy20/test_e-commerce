...
class Product_Category extends StatelessWidget {
  const Product_Category({super.key});
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<ProductsResponse>>(
        future: ProductsAPI().getProductsByCategory(
            "${getCategoryBasedOnIndex(Provider.of<SelectedCategoryProvider>(context).selectedCat)}"),
